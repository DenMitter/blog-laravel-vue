        ...
        <div class="sidebar" :class="{ showOverlay: overlayVisibility }">
            ...
            <div class="side-links">
                <ul>
                    ...
                    <li><router-link v-if="!loggedIn" @click="hideOverlay" :to="{ name: 'Register' }">Register</router-link></li>
                    <li><router-link v-if="!loggedIn" @click="hideOverlay" :to="{ name: 'Login' }">Login</router-link></li>
                    <li><router-link v-if="loggedIn" @click="hideOverlay" :to="{ name: 'Dashboard' }">Dashboard</router-link></li>
                </ul>
            </div>
